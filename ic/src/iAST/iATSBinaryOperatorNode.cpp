...
Ptr<iASTNode> iATSBinaryOperatorNode::getLeft() const noexcept { return this->left; }

Ptr<iASTNode> iATSBinaryOperatorNode::getRight() const noexcept { return this->right; }

...
#include <icore/exception/errorcode.h>
    ...
    SPACE(core)
    {
        SPACE(iexception)
        {
            ...
            public:
                ...
                *
                **/
                template<typename emsg_t>
                inline static ErrorInfo getErrorInfoFrom(EMT emt, emsg_t emsg)
                {
                    throw - 1;
                }
                /*
            ...
            template<>
            inline ErrorInfo error::getErrorInfoFrom<ErrorCode>(EMT emt, ErrorCode emsg)
            {
...
#undef XX
            ...
            template<>
            inline ErrorInfo error::getErrorInfoFrom<int>(EMT emt, int emsg)
            {
...
#undef XX
            ...
            template<>
            inline ErrorInfo error::getErrorInfoFrom<CRef<std::string>>(EMT emt, CRef<std::string> emsg)
            {

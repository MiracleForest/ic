...
SPACE(i)
{
    SPACE(core)
    {
        SPACE(math)
        {
            ...
            static iFraction operator+(int n, iFraction f)
            {
                return f + n;
            }
            static iFraction operator-(int n, iFraction f)
            ...
            inline Ref<iFraction> operator+=(Ref<iFraction> l, CRef<iFraction> r)
            {
                const iFraction f = l;
                l.setNumerator((l + r).getNumerator());
                l.setDenominator((l + r).getDenominator());
                return l;
            }
            inline Ref<iFraction> operator-=(Ref<iFraction> l, CRef<iFraction> r)
            {
            ...
            inline bool operator==(CRef<iFraction> l, CRef<iFraction> r)
            {
                return l.getDenominator() == r.getDenominator() && l.getNumerator() == r.getNumerator();
            }
            inline bool operator!=(CRef<iFraction> l, CRef<iFraction> r)
            {
                return l.getDenominator() != r.getDenominator() || l.getNumerator() != r.getNumerator();

    ...
    SPACE(core)
    {
        SPACE(data)
        {
            ...
            public:
                ...
                iRBStream(unkTypev dat, size_t len)
                {
                    data = (uintptr_t)dat;
                    (void)len;
#ifdef BUF_CHK
            ...
            private:
                ...
                void __get(Ref<T> x)
                {
                    if constexpr (is_safe_obj<T>())
                    {
                        ...
                        memcpy(&x, (unkTypev)data, sizeof(x));
                        data += sizeof(T);
                        DO_BUF_CHK();
                    }
                    else
            ...
            public:
                ...
                void read(unkTypev dst, size_t n)
                {
                    memcpy(dst, (unkTypev)data, n);
                    data += n;
                    DO_BUF_CHK();
                }
            ...
            public:
                ...
                void write(const unkTypev src, size_t n)
                {
